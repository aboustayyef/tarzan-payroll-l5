    ...
    public function run()
    {
		...
		$employees = $employees->map(function($employee){
			return [
	            ...
	            'name' => $employee[2] ,
	            'date_of_birth' => !empty($employee[3])? Carbon::createFromFormat('d/m/Y', $employee[3]) : NULL,
	            'date_joined' => !empty($employee[3])? Carbon::createFromFormat('d/m/Y', $employee[6]) : NULL,
	            'location' => $employee[4],
